...
class choosemajorVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        if let majorUpdate = cell.username.text {
            ...
            let controller = self.storyboard!.instantiateViewControllerWithIdentifier("year")
